# ¡Hola! Soy Maritza Fuentes 👋
## Desarrolladora Full Stack JavaScript Trainee

Me apasiona la lógica del backend, el diseño y modelado de bases de datos relacionales, y la automatización de procesos eficientes. Actualmente me encuentro en búsqueda de mi primera oportunidad laboral en el sector TI para aportar valor en células de desarrollo ágiles.
...
* **Bases de Datos:** PostgreSQL, consultas SQL relacionales, modelado Entidad-Relación.
* **Herramientas y Metodologías:** Git, GitHub, DBeaver, Scrum/Agile (Trello, Jira), Documentación Técnica.
